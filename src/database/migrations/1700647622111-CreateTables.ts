...
// export class CreateTables1700647622111 implements MigrationInterface {
//     name = 'CreateTables1700647622111'
...
//         await queryRunner.query(`CREATE TABLE "products" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "image" character varying NOT NULL DEFAULT '', "description" character varying NOT NULL DEFAULT '', "favorites" boolean NOT NULL DEFAULT false, "caloricContent" character varying NOT NULL DEFAULT '', "proteins" character varying NOT NULL DEFAULT '', "fats" character varying NOT NULL DEFAULT '', "carbohydrates" character varying NOT NULL DEFAULT '', "price" integer, "quantity" integer, "unit" character varying, "deliveryType" "public"."products_deliverytype_enum" NOT NULL, "address" character varying, "phoneNumber" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "specialOffer" boolean, "topProduct" boolean, "newProduct" boolean, "sellerId" integer, "categoryId" uuid, "subcategoryId" uuid, "subsubcategoryId" uuid, CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`);
//         await queryRunner.query(`CREATE TYPE "public"."sellers_typesaler_enum" AS ENUM('privatePerson', 'business')`);
//         await queryRunner.query(`CREATE TABLE "sellers" ("id" SERIAL NOT NULL, "companyName" character varying NOT NULL DEFAULT '', "phoneNumber" character varying NOT NULL, "typeSaler" "public"."sellers_typesaler_enum" NOT NULL DEFAULT 'privatePerson', "address" character varying NOT NULL DEFAULT '', "workingHours" character varying NOT NULL DEFAULT '', "image" character varying NOT NULL DEFAULT 'https://res.cloudinary.com/debx785xm/image/upload/v1698740839/xqj2utbevda5n8hfjkxf.jpg', "logo" character varying NOT NULL DEFAULT '', "aboutUs" character varying NOT NULL DEFAULT '', "contactPerson" character varying, "isActive" boolean NOT NULL DEFAULT false, "userId" integer, CONSTRAINT "UQ_7e871210364bc7ca8c395f8f89c" UNIQUE ("phoneNumber"), CONSTRAINT "REL_4c1c59db4ac1ed90a1a7c0ff3d" UNIQUE ("userId"), CONSTRAINT "PK_97337ccbf692c58e6c7682de8a2" PRIMARY KEY ("id"))`);
//         await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('buyer', 'seller', 'admin')`);
//         await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "email" character varying NOT NULL, "emailVerified" boolean NOT NULL DEFAULT false, "password" character varying NOT NULL, "role" "public"."users_role_enum" NOT NULL DEFAULT '[object Object]', CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);

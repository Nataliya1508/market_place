...
export class SellerEntity {
  ...
  companyName: string;
   ...
   @ApiProperty({ example: '+380956789000', description: 'The phone number of the seller.' })
  @Column({ unique: true })
  phoneNumber: string;

  @ApiProperty({ enum: TypeSaler, default: TypeSaler.PrivatePerson, description: 'The type of the seller.' })
  ...
  @ApiProperty({ example: '9 AM - 9 PM', description: 'The working hours of the company.' })
  @Column({ default: '' })
  workingHours: string;
  ...
  @ApiProperty({ example: 'Alexandr', description: 'The contact person of the seller.' })
